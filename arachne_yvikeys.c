...
{
   int         i           =    0;
   /*> yVIKEYS_view_config   ("arachne-anassa (spider queen) visualization and simulation", P_VERNUM, YVIKEYS_OPENGL, 800, 500, 0);   <*/
   ...
   yCMD_direct   (":xaxis    disable");
   yCMD_direct   (":yaxis    disable");
   yCMD_direct   (":ribbon   disable");
   yCMD_direct   (":nav      disable");
   yCMD_direct   (":alt      disable");
   yCMD_direct   (":formula  disable");
   yCMD_direct   (":layout   work");
   yCMD_direct   (":progress show");
   yCMD_direct   (":buffer   disable");
   /*---(colors)-------------------------*/
   yCMD_direct   (":palette 100 rcomp pale earthy");
